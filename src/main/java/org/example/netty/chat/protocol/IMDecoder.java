...
public class IMDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in,List<Object> out) throws Exception {
        try{
            ...
            out.add(new MessagePack().read(array,IMassage.class));
            in.clear();
     ...
     * @return
     */
    public IMassage decode(String msg){
        ...
        try{
            ...
            if(msg.startsWith("[" + IMP.LOGIN.getName() + "]")){
                return new IMassage(heards[0],time,nickName);
            }else if(msg.startsWith("[" + IMP.CHAT.getName() + "]")){
                return new IMassage(heards[0],time,nickName,content);
